package com.housedevinci.shredding.autoconfigure.tenthpass.quotedcol;
 ...
 */
@Entity
@Table(name = "quotedcol_note")
public class QuotedColNote {
  ...
  protected QuotedColNote() {}

  public QuotedColNote(String ownerId, String tenantId, String email) {
