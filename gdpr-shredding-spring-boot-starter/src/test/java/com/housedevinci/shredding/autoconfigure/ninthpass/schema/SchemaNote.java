...
/**
 * The ninth pass, K1 lesson: the blind-index table lives in a schema of its own. When this fixture
 * was written the erasure interpolated {@code BlindIndexColumn.table()} unqualified, so what it
 * updated - and what {@code verifyCleared} read back - depended on the connection's {@code
